...
async function main(): Promise<void> {
  ...
  // ─── Services ─────────────────────────────────────────────────
  const services = [
    { category: 'naegel', slug: 'naegel-modellage-gel', name: 'Nagel-Modellage Gel', duration: 90, price: '95.00', description: 'Neumodellage mit Gel-Aufbau' },
    { category: 'naegel', slug: 'naegel-refill', name: 'Nagel-Refill', duration: 60, price: '65.00', description: 'Auffüllen einer bestehenden Modellage' },
    { category: 'naegel', slug: 'manikuere', name: 'Maniküre klassisch', duration: 45, price: '45.00', description: 'Nagelpflege + Lack' },
    { category: 'naegel', slug: 'pedikuere', name: 'Pediküre', duration: 60, price: '70.00', description: 'Medizinische Fusspflege + Lack' },
    { category: 'wimpern', slug: 'wimpernverlaengerung-classic', name: 'Wimpern Classic', duration: 90, price: '130.00', description: 'Einzelwimpern-Verlängerung' },
    { category: 'wimpern', slug: 'wimpernverlaengerung-volume', name: 'Wimpern Volume', duration: 120, price: '180.00', description: '3D-Volumen-Wimpern' },
    { category: 'wimpern', slug: 'wimpern-refill', name: 'Wimpern-Refill', duration: 60, price: '75.00', description: 'Auffüllen bestehender Verlängerung' },
    { category: 'brauen', slug: 'brauen-zupfen', name: 'Brauen zupfen + formen', duration: 30, price: '35.00', description: 'Formkorrektur mit Pinzette' },
    { category: 'brauen', slug: 'brauen-laminierung', name: 'Brauen-Laminierung', duration: 60, price: '85.00', description: 'Aufrichten + Fixieren' },
    { category: 'kosmetik', slug: 'gesichtsbehandlung-classic', name: 'Gesichtsbehandlung Classic', duration: 60, price: '95.00', description: 'Reinigung + Peeling + Maske' },
    { category: 'kosmetik', slug: 'hydrafacial', name: 'HydraFacial', duration: 60, price: '180.00', description: 'Tiefenreinigung + Hydration' },
  ] as const;
