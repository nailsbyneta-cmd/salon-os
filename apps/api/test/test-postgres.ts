...
// v4-UUIDs (version=4, variant=8/9/a/b) — withTenant() validiert strikt.
const SEED_TENANT_ID = '11111111-1111-4111-8111-111111111111';
const SEED_LOCATION_ID = '22222222-2222-4222-8222-222222222222';
const SEED_USER_ID = '33333333-3333-4333-8333-333333333333';
const SEED_STAFF_ID = '44444444-4444-4444-8444-444444444444';
const SEED_CATEGORY_ID = '55555555-5555-4555-8555-555555555555';
